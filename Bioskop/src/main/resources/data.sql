...
insert into user(username, password, usertype, address_id, email, firstname, lastname, is_first_login, profile_picture, activated) values ('sara', 'sara', 'CINEMAADMIN', '11', 'sarapetrovic03@gmail.com', 'Sara', 'Petrovic', false, 'default-profile-picture.jpg', true)
...
insert into projection(name, date, price, hall_id, movie_or_performance_id, theater_or_cinema_id) values ('Occupation 2018-06-30 22:00', '2018-06-30T22:00', 350.00, 2, 2, 2)  
insert into projection(name, date, price, hall_id, movie_or_performance_id, theater_or_cinema_id) values ('Occupation 2018-06-30 18:00', '2018-06-30T18:00', 350.00, 2, 2, 2)  
insert into projection(name, date, price, hall_id, movie_or_performance_id, theater_or_cinema_id) values ('Occupation 2018-06-30 20:00', '2018-06-30T22:00', 350.00, 3, 2, 3)  
...
insert into theater_or_cinema_halls(theater_or_cinema_id, halls_id) values (2, 2)
