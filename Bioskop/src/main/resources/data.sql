...
insert into item_ad( name, description ,version, owner_id, picture, approved, expiry_date, active) values ( 'duks', 'opis' ,0, 4,'item2.jpg', true, '2018-06-12', true)
insert into item_ad( name, description ,version, owner_id, picture, approved, expiry_date, active) values ( 'Majica', 'opis' ,0, 4,'item2.jpg', false, '2018-06-12', true)
insert into item_ad( name, description ,version, owner_id, picture, approved, expiry_date, active) values ( 'duks', 'opis' ,0, 4,'item2.jpg', false, '2018-06-12', true)
insert into official_item( name, price,description,version, quantity, picture) values ( 'duks', '700', 'opis', 0 ,2, 'item2.jpg')
insert into official_item( name, price,description,version, quantity, picture) values ( 'majica', '700', 'opis', 0 ,2, 'item1.jpg')
insert into official_item( name, price,description,version, quantity, picture) values ( 'kapa', '700', 'opis', 0 ,2, 'item.jpg')
insert into official_item( name, price,description,version, quantity, picture) values ( 'majica', '700', 'opis', 0 ,2, 'item1.jpg')
...
insert into item_offer(user_id, price, item_ad_id, accepted, version) values ('6', '300', '3', false ,'0')
insert into item_offer(user_id, price, item_ad_id, accepted, version) values ('7', '300', '3', false ,'0')
